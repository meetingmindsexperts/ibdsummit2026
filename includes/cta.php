...
$cta_heading = $cta_heading ?? 'Join us in GCC IBD Summit 2026';
$wrap_id     = isset($cta_id) ? ' id="' . e($cta_id) . '"' : '';
?>
<section class="sci-cta" id="join">
  <div class="wrap"<?= $wrap_id ?>>
    <img class="ji-png" src="/assets/img/journey-icon-white.png" alt="">
    <span class="divider"></span>
    <h2><?= e($cta_heading) ?></h2>
    <a class="btn btn--white" href="/programme">View the programme <span class="arrow">→</span></a>
  </div>
</section>
<?php
